        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SightLeft = table.Column<double>(type: "float", nullable: false),
                    SightRight = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Frame_Form = table.Column<int>(type: "int", nullable: true),
                    ...
                    Glasses_Dioptre = table.Column<double>(type: "float", nullable: true),
                    Dioptre = table.Column<double>(type: "float", nullable: true),
                    BaseCurve = table.Column<double>(type: "float", nullable: true),
                    NumberOfUnits = table.Column<int>(type: "int", nullable: true),
                    Diameter = table.Column<double>(type: "float", nullable: true),
                    ExpirationDate = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Timetables_Exercises_ExerciseId",
